                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    <label for="document-name" class="block text-sm font-medium text-gray-700">Date of
                                        Entry</label>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <div>
                                        <label class="text-base font-medium text-gray-900">Select Process</label>
                                        <fieldset class="mt-4">

                                            <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                                <div class="flex items-center">
                                                    <input @click="count = 1" id="email" name="notification-method"
                                                        type="radio"
                                                ...
                                                <div class="flex items-center">
                                                    <input id="sms" @click="count = 2" name="notification-method"
                                                        type="radio"
                                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                    <label for="sms"
                                                        class="ml-3 block text-sm font-medium text-gray-700">
                                                ...
                                                <div class="flex items-center" @click="count = 3">
                                                    <input @click="count = 3" id="push" name="notification-method"
                                                        type="radio"
                                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                    <label for="push"
                                                        class="ml-3 block text-sm font-medium text-gray-700">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="px-6 flex py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="/document/edit/12" class="text-indigo-600 hover:text-indigo-900 mr-2"><svg
