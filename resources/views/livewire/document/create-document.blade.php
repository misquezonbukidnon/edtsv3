        ...
        <ol role="list" class="bg-white rounded-md shadow px-6 flex space-x-4">
            ...
            <li class="flex">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('create-document') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Create Document</a>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="max-w-7xl mb-16 mt-5 mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="country" class="block text-sm font-medium text-gray-700">Select
                                        Process</label>
