                        ...
                        <table class="min-w-full table-fixed divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap py-4 pr-3 text-sm font-medium text-gray-900">PR-001
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Purchase Request
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Ivan Store
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">For porn videos
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Pending
                                    </td>
