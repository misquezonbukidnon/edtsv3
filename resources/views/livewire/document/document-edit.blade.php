<div>
    ...
    <!-- Data Viewing And Editing Section -->
                                        ...
                                        <select id="pr_office" wire:model="pr_office_id_submit"
                                            ...
                                            @foreach ($pr_office as $office)
                                                @if ($pr_office_name != $office->name)
                                                    <option wire:key="{{ $office->id }}"
                                                        @click="dd($office_id_submit)" value="{{ $office->id }}">
...
<div class="sm:col-span-2">
    ...
    <div class="mt-1">
        <input type="text" wire:model="pr_abc_amount" name="budget" id="budget" autocomplete="budget"
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input wire:model="po_reference_id" type="text" name="po_reference_id" id="po_reference_id"
                                autocomplete="po_reference_id"
                                class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <select id="po_purchase_description_id_submit"
                                wire:model="po_purchase_description_id_submit" autocomplete="Particulars-name"
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('purchase_description_id') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror">
...
<div class="sm:col-span-6">
    ...
    <div class="mt-1">
        <input type="text" wire:model="po_description" name="po_description" id="po_description" autocomplete="purpose"
...
<div class="sm:col-span-6">
    ...
    <div class="mt-1">
        <input type="text" wire:model="po_lcb_amount" name="po_lcb_amount" id="po_lcb_amount"
            autocomplete="po_lcb_amount" placeholder="Enter Contract Price"
            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
</div>
...
<div class="sm:col-span-6">
    ...
    <div class="mt-1">
        <select id="suppliers" wire:model="po_supplier_id_submit" name="suppliers" autocomplete="suppliers"
            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <input type="text" wire:model="voucher_sub_reference_id" name="voucher_sub_reference_id"
                                id="voucher_sub_reference_id" autocomplete="voucher_sub_reference_id"
                                class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
...
<div class="sm:col-span-6">
    ...
    <div class="mt-1">
        <input type="text" wire:model="voucher_purchase_description" name="purpose" id="purpose" autocomplete="purpose"
            placeholder="Purchase Request Purpose"
            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
</div>
...
<div wire:ignore.self class="sm:col-span-6">
    ...
    <div class="mt-1">
        <select id="suppliers" wire:model="voucher_payee_id_submit" name="suppliers" autocomplete="suppliers"
            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
...
<div class="sm:col-span-6">
    ...
    <div class="mt-1">
        <input type="text" wire:model="voucher_abc_amount" name="amount" id="amount" autocomplete="amount"
...
<!-- End of Data Viewing And Editing Section -->
</div>
